 ...
 */
async function routePrompt(prompt, context, history, options, wasmAvailable) {
 ...
 */
function routeWithHeuristics(prompt, context, history) {
    const features = extractPromptFeatures(prompt, context, history);
    let model;
    let reasoning;
 ...
 */
function extractPromptFeatures(prompt, context, history) {
 ...
 */
function simulateFastGRNN(embedding, hiddenDim, updateGate) {
 ...
 */
function displayRoutingDecision(selection, explain, verbose) {
