 ...
 */
export declare function isBackendAvailable(backend: 'ruvector' | 'rvf' | 'hnswlib'): Promise<boolean>;
/**
 * Get installation instructions for a backend
 */
export declare function getInstallCommand(backend: 'ruvector' | 'rvf' | 'hnswlib'): string;
