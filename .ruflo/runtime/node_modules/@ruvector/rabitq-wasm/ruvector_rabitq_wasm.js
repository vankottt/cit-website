...
export class RabitqIndex {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(RabitqIndex.prototype);
        obj.__wbg_ptr = ptr;
        RabitqIndexFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RabitqIndexFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_rabitqindex_free(ptr, 0);
    }
    /**
     ...
     * @returns {RabitqIndex}
     */
    static build(vectors, dim, seed, rerank_factor) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF32ToWasm0(vectors, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.rabitqindex_build(retptr, ptr0, len0, dim, seed, rerank_factor);
     ...
     */
    get isEmpty() {
        const ret = wasm.rabitqindex_isEmpty(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get len() {
        const ret = wasm.rabitqindex_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    search(query, k) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF32ToWasm0(query, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.rabitqindex_search(retptr, this.__wbg_ptr, ptr0, len0, k);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
if (Symbol.dispose) RabitqIndex.prototype[Symbol.dispose] = RabitqIndex.prototype.free;
...
export class SearchResult {
     ...
     */
    get distance() {
        const ret = wasm.__wbg_get_searchresult_distance(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    get id() {
        const ret = wasm.__wbg_get_searchresult_id(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
const RabitqIndexFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_rabitqindex_free(ptr >>> 0, 1));
