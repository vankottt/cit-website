...
export declare class ReflexionMemory {
    ...
    constructor(db: Database, embedder: EmbeddingService, vectorBackend?: VectorBackend, learningBackend?: LearningBackend, graphBackend?: GraphBackend);
    /**
     ...
     */
    getLearningStats(): import("../backends/LearningBackend.js").LearningStats;
    /**
     * Get graph backend statistics
     */
    getGraphStats(): import("../backends/GraphBackend.js").GraphStats;
}
export {};
