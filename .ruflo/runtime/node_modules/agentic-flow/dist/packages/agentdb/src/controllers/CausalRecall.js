...
export class CausalRecall {
    ...
    embedder;
    vectorBackend;
    constructor(db, embedder, vectorBackend, config = {
        alpha: 0.7,
        beta: 0.2,
        gamma: 0.1,
        minConfidence: 0.6
     ...
     */
    async search(params) {
        const { query, k = 12, includeEvidence = false, alpha = this.config.alpha, beta = this.config.beta, gamma = this.config.gamma } = params;
...
//# sourceMappingURL=CausalRecall.js.map