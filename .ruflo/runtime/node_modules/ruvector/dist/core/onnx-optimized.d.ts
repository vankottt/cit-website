 ...
 */
import { EmbedTextKind } from './embedding-provenance';
...
export declare class OptimizedOnnxEmbedder {
    ...
    embedFor(role: EmbedTextKind, text: string): Promise<Float32Array>;
    private embedKind;
    private embedRaw;
    /**
    ...
    embedBatchFor(kind: EmbedTextKind, texts: string[]): Promise<Float32Array[]>;
    /**
