 ...
 *  future.
 */
export async function uniffiRustCallAsync(rustCaller, rustFutureFunc, pollFunc, cancelFunc, completeFunc, freeFunc, liftFunc, liftString, asyncOpts, errorHandler) {
    ...
    const keepAlive = typeof setTimeout === "function"
...
// For testing only.
export function uniffiRustFutureHandleCount() {
    return UNIFFI_RUST_FUTURE_RESOLVER_MAP.size;
}
//# sourceMappingURL=async-rust-call.js.map