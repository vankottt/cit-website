 ...
 */
export declare const uniffiCreateRecord: <T, D extends Partial<T>>(defaults: () => D) => (partial: Partial<T> & Required<Omit<T, keyof D | { [K in keyof T]-?: undefined extends T[K] ? K : never; }[keyof T]>>) => T;
