...
const ffi_types_ts_1 = require("./ffi-types.js");
...
class AbstractFfiConverterByteArray {
    lift(value) {
        const buffer = ffi_types_ts_1.RustBuffer.fromUint8Array(value);
        return this.read(buffer);
    }
    lower(value, alloc) {
        const view = alloc(this.allocationSize(value));
        const buffer = ffi_types_ts_1.RustBuffer.fromUint8Array(view);
    ...
    class FFIConverter extends AbstractFfiConverterByteArray {
        read(from) {
            ...
            if (ms === Number.POSITIVE_INFINITY || ms === Number.NEGATIVE_INFINITY) {
                throw new errors_ts_1.UniffiInternalError.NumberOverflow();
            }
...
exports.FfiConverterTimestamp = (() => {
    ...
    function safeDate(ms) {
        if (Math.abs(ms) > 8.64e15) {
            throw new errors_ts_1.UniffiInternalError.DateTimeOverflow();
        }
        return new Date(ms);
    }
    class FFIConverter extends AbstractFfiConverterByteArray {
...
exports.FfiConverterUint8Array = (() => {
    const lengthConverter = exports.FfiConverterInt32;
    class FFIConverter extends AbstractFfiConverterByteArray {
        read(from) {
            const length = lengthConverter.read(from);
    ...
    class FFIConverter {
        ...
        write(value, into) {
            if (converter.writeStringIntoBuffer) {
                ...
                const bytesWritten = converter.writeStringIntoBuffer(value, into, dataOffset);
                new DataView(into.arrayBuffer, lengthOffset, 4).setInt32(0, bytesWritten, false);
...
//# sourceMappingURL=ffi-converters.js.map