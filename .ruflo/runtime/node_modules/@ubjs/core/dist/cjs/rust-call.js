...
function uniffiCheckCallStatus(callStatus, liftString, errorHandler) {
    switch (callStatus.code) {
        ...
        case exports.CALL_ERROR: {
            ...
            throw new errors_ts_1.UniffiInternalError.UnexpectedRustCallError();
        }
        case exports.CALL_UNEXPECTED_ERROR: {
            ...
            if (errorBuf) {
                if (errorBuf.byteLength > 0) {
                    throw new errors_ts_1.UniffiInternalError.RustPanic(liftString(errorBuf));
                }
            }
            throw new errors_ts_1.UniffiInternalError.RustPanic("Rust panic");
        }
        case exports.CALL_CANCELLED:
            ...
            throw new errors_ts_1.UniffiInternalError.AbortError();
        default:
            throw new errors_ts_1.UniffiInternalError.UnexpectedRustCallStatusCode();
    }
}
//# sourceMappingURL=rust-call.js.map