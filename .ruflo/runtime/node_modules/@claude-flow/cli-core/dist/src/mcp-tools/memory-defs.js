...
export const memoryToolDefs = [
    ...
    {
        name: 'memory_stats',
        description: 'Backend health and size summary — total entries, namespaces in use, on-disk size in bytes, backend identifier (json or sqlite-hnsw). Useful for "what does this project have stored?" diagnostics.',
        category: 'memory',
        inputSchema: { type: 'object', properties: {} },
    },
];
//# sourceMappingURL=memory-defs.js.map