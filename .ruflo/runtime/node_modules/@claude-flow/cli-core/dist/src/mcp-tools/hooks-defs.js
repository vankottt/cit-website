...
export const hooksToolDefs = [
    ...
    },
    {
        ...
        description: 'Record an Edit/Write/MultiEdit outcome — file path, success flag — so the system can train neural patterns on what worked. Use AFTER each Edit to feed the auto-routing learning loop. The trained patterns let future similar edits route through the cheaper tier.',
        category: 'hooks',
        inputSchema: {
            type: 'object',
            properties: {
    ...
    },
    {
        ...
        description: 'Record the outcome of a model selection (success / escalated / failure) so the router learns which tier handled the task best. Typed equivalent of the legacy routing-outcomes namespace. Use after an applied cost-optimize recommendation closes the loop on whether the downgrade worked.',
        category: 'hooks',
        inputSchema: {
            type: 'object',
            properties: {
    ...
    },
    {
        ...
        description: 'Recommend a model (haiku / sonnet / opus) for a given task description based on past routing-outcomes. Use when you have a task and want the router\'s opinion before paying for Sonnet. Returns null if no learned signal exists yet — fall back to your default model.',
        category: 'hooks',
        inputSchema: {
            type: 'object',
            properties: {
    ...
    {
        name: 'hooks_explain',
        description: 'Why did the router pick what it picked? Returns a human-readable explanation of the most recent routing decision for a topic — which past trajectories matched, what tier was selected, what the confidence was. Useful when an agent picks Sonnet for something you expected to route to Haiku.',
        category: 'hooks',
        inputSchema: {
            type: 'object',
            properties: {
...
//# sourceMappingURL=hooks-defs.js.map