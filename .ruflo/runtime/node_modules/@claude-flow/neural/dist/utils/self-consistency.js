 ...
 */
export async function selfConsistency(operation, config) {
    ...
    const aggregator = config.aggregator ?? 'majority';
    let finalAnswer;
    let agreement;
    if (aggregator === 'majority') {
        ...
        for (const s of samples) {
            ...
            if (existing)
                ...
                counts.set(key, { value: s, count: 1 });
        }
        let best = { value: samples[0], count: 0 };
