 ...
 */
export function blendedPrice(modelId) {
 ...
 */
export function costUsd(modelId, inputTokens, outputTokens) {
    if (!inputTokens && !outputTokens)
        return 0;
    const p = (modelId ? MODEL_PRICES[modelId] : undefined) ?? { in: 1.0, out: 1.0 };
