...
export async function callMCPTool(toolName, input = {}, context) {
    ...
    try {
        ...
        return applyContentBoundaryGuardrail(toolName, result);
    }
    catch (error) {
 ...
 */
let _guardrailInstance = null;
function applyContentBoundaryGuardrail(toolName, result) {
    if (process.env.CLAUDE_FLOW_STRICT_GUARDRAIL !== 'true')
        return result;
    ...
    if (_guardrailInstance === null) {
        try {
            ...
            const sec = require('@claude-flow/security');
