...
export class PluginDiscoveryService {
    ...
    async discoverRegistry(registryName) {
        ...
        try {
            ...
            if (this.config.requireVerification) {
                ...
                if (!verified) {
                    console.warn(`[PluginDiscovery] Registry signature verification failed for ` +
    ...
    async verifyRegistrySignature(registry, expectedPublicKey) {
        ...
        const registryToVerify = { ...registry };
        ...
        return verifyEd25519Signature(message, registry.registrySignature, expectedPublicKey);
    }
    /**
