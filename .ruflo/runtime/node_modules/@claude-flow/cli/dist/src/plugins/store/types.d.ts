 ...
 */
export type PluginType = 'agent' | 'hook' | 'command' | 'provider' | 'integration' | 'theme' | 'core' | 'hybrid' | 'harness';
/**
 * Plugin dependency
 */
 ...
 * Plugin permissions
 */
export type PluginPermission = 'network' | 'filesystem' | 'execute' | 'memory' | 'agents' | 'credentials' | 'config' | 'hooks' | 'privileged';
/**
 * Security audit info
 */
