...
export function typePenalty(name, factor = 0.5, regex = META_COMMIT_REGEX) {
    if (!name)
        return 1.0;
 ...
 */
export function hybridScores(cosine, bm25, alpha = 0.6) {
 ...
 */
export function multiFieldBM25(queryTokens, subjectTokens, bodyTokens, subjectStats, bodyStats, subjectWeight = 3.0, bodyWeight = 1.0) {
 ...
 */
export function mmrRerank(candidates, k, lambda = 0.5) {
