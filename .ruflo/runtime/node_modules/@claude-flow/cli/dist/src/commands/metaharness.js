...
function dispatchPluginScript(scriptDir, scriptName, extraArgs) {
...
export const metaharnessCommand = {
    name: 'metaharness',
    description: 'MetaHarness integration (ADR-150) — score / genome / mcp-scan / threat-model / mint. Subprocess-invoked plugin skills with graceful degradation.',
    options: [
        {
            name: 'subcommand',
    ...
    async action(context) {
        ...
        const ctxFlags = context.flags || {};
        const reconstructedFlags = [];
