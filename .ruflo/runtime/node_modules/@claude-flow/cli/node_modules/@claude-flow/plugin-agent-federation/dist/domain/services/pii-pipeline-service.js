...
export class PIIPipelineService {
    ...
    constructor(deps, policy, confidenceThresholds) {
        this.deps = deps;
        this.policy = {
    ...
    detect(text) {
        ...
        for (const [type, pattern] of Object.entries(PII_PATTERNS)) {
            ...
            while ((match = regex.exec(text)) !== null) {
                ...
                const confidence = this.computeConfidence(type, match[0], text);
                detections.push({
                    type: type,
                    value: match[0],
                    confidence,
    ...
    updateCalibration(type, calibration) {
        this.calibrations.set(type, calibration);
    }
    getCalibration(type) {
        return this.calibrations.get(type);
    }
    computeConfidence(type, value, _fullText) {
    ...
    static defaultPolicyMatrix() {
        return { ...DEFAULT_POLICY_MATRIX };
    }
}
//# sourceMappingURL=pii-pipeline-service.js.map