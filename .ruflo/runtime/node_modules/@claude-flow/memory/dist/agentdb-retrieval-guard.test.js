...
import { AgentDbRetrievalGuard, createAgentDbRetrievalGuard, isRetrievalGuardEnabled, isRetrievalGuardStrict, } from './agentdb-retrieval-guard.js';
...
describe('feature flag readers', () => {
    ...
    afterEach(() => {
        if (ORIGINAL_GUARD === undefined)
            ...
            process.env.CLAUDE_FLOW_RETRIEVAL_GUARD = ORIGINAL_GUARD;
        if (ORIGINAL_STRICT === undefined)
            delete process.env.CLAUDE_FLOW_RETRIEVAL_GUARD_STRICT;
        else
            process.env.CLAUDE_FLOW_RETRIEVAL_GUARD_STRICT = ORIGINAL_STRICT;
    });
...
//# sourceMappingURL=agentdb-retrieval-guard.test.js.map