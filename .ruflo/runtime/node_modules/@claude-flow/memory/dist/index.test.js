...
describe('Phase 2 — createHybridService returns a real HybridBackend', () => {
    it('returns a MemoryService whose backend is a HybridBackend instance', async () => {
        ...
        const embedder = async (_text) => new Float32Array(384);
