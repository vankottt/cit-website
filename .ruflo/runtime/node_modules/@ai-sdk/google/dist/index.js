...
var googleTranscriptionModelOptions = import_v42.z.object({
  /**
   ...
   */
  languageCodes: import_v42.z.array(import_v42.z.string()).optional(),
  /**
   * Custom vocabulary phrases, which bias the speech recognition model
   * toward recognizing specific terms.
   */
  customVocabulary: import_v42.z.array(import_v42.z.string()).optional(),
  /**
   * Enables word-level timestamp generation.
   */
  wordTimestamp: import_v42.z.boolean().optional(),
  /**
   * Enables speaker diarization.
   */
  diarization: import_v42.z.boolean().optional(),
  /**
   ...
   */
  mode: import_v42.z.enum(["SMART", "VERBATIM"]).optional()
});
...
var GoogleTranscriptionModel = class {
  ...
  async parseOptions(providerOptions) {
    return (0, import_provider_utils2.parseProviderOptions)({
      provider: "google",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    if (isLiveTranscriptionModelId(this.modelId)) {
      throw new import_provider.InvalidArgumentError({
        argument: "modelId",
        message: `Model '${this.modelId}' only supports streaming transcription, which requires AI SDK v7. Use a unary model such as 'gemini-3.5-transcribe'.`
      });
    }
    ...
    const requestBody = {
      ...
      input: [
        {
          type: "audio",
          data: (0, import_provider_utils2.convertToBase64)(options.audio),
    ...
    const {
      ...
      headers: (0, import_provider_utils2.combineHeaders)(
        this.config.headers ? await (0, import_provider_utils2.resolve)(this.config.headers) : void 0,
        options.headers
      ),
      body: requestBody,
...
var googleInteractionsWordAnnotationSchema = import_v43.z.object({
  type: import_v43.z.string().nullish(),
  text: import_v43.z.string().nullish(),
  speaker: import_v43.z.string().nullish(),
  start_offset: import_v43.z.string().nullish(),
  end_offset: import_v43.z.string().nullish()
});
var googleInteractionsTranscriptionResponseSchema = import_v43.z.object({
  status: import_v43.z.string().nullish(),
  steps: import_v43.z.array(
    import_v43.z.object({
      type: import_v43.z.string().nullish(),
      content: import_v43.z.array(
        import_v43.z.object({
          type: import_v43.z.string().nullish(),
          text: import_v43.z.string().nullish(),
          annotations: import_v43.z.array(googleInteractionsWordAnnotationSchema).nullish()
        })
      ).nullish()
    })
  ).nullish(),
  usage: import_v43.z.record(import_v43.z.string(), import_v43.z.unknown()).nullish()
});
...
var googleEmbeddingContentPartSchema = import_v44.z.union([
  import_v44.z.object({ text: import_v44.z.string() }),
  import_v44.z.object({
    inlineData: import_v44.z.object({
      mimeType: import_v44.z.string(),
      data: import_v44.z.string()
    })
  }),
  import_v44.z.object({
    fileData: import_v44.z.object({
      fileUri: import_v44.z.string(),
      mimeType: import_v44.z.string()
    })
  })
]);
var googleEmbeddingModelOptions = (0, import_provider_utils3.lazySchema)(
  () => (0, import_provider_utils3.zodSchema)(
    import_v44.z.object({
       ...
       */
      outputDimensionality: import_v44.z.number().optional(),
      /**
       ...
       */
      content: import_v44.z.array(import_v44.z.array(googleEmbeddingContentPartSchema).min(1).nullable()).optional()
    })
  )
);
...
var googleGenerativeAITextEmbeddingResponseSchema = (0, import_provider_utils4.lazySchema)(
  () => (0, import_provider_utils4.zodSchema)(
    import_v45.z.object({
      embeddings: import_v45.z.array(import_v45.z.object({ values: import_v45.z.array(import_v45.z.number()) }))
    })
  )
);
var googleGenerativeAISingleEmbeddingResponseSchema = (0, import_provider_utils4.lazySchema)(
  () => (0, import_provider_utils4.zodSchema)(
    import_v45.z.object({
      embedding: import_v45.z.object({ values: import_v45.z.array(import_v45.z.number()) })
    })
  )
);
...
function isRecursiveJSONSchemaReferenceError(error) {
  return import_provider3.UnsupportedFunctionalityError.isInstance(error) && error.functionality.startsWith(recursiveReferenceFunctionalityPrefix);
}
                ...
                if (isServerToolCall) {
                  return {
                    toolCall: {
                      ...
                      args: typeof part.input === "string" ? (0, import_provider_utils5.secureJsonParse)(part.input) : part.input,
                      id: serverToolCallId
                    },
...
var googleLanguageModelOptions = (0, import_provider_utils6.lazySchema)(
  () => (0, import_provider_utils6.zodSchema)(
    import_v46.z.object({
      responseModalities: import_v46.z.array(import_v46.z.enum(["TEXT", "IMAGE"])).optional(),
      thinkingConfig: import_v46.z.object({
        thinkingBudget: import_v46.z.number().optional(),
        includeThoughts: import_v46.z.boolean().optional(),
        // https://ai.google.dev/gemini-api/docs/gemini-3?thinking=high#thinking_level
        thinkingLevel: import_v46.z.enum(["minimal", "low", "medium", "high"]).optional()
      }).optional(),
      /**
       * Optional.
       ...
       */
      cachedContent: import_v46.z.string().optional(),
      /**
       ...
       */
      structuredOutputs: import_v46.z.boolean().optional(),
      /**
       * Optional. A list of unique safety settings for blocking unsafe content.
       */
      safetySettings: import_v46.z.array(
        import_v46.z.object({
          category: import_v46.z.enum([
       ...
       */
      audioTimestamp: import_v46.z.boolean().optional(),
      /**
       * Optional. Defines labels used in billing reports. Available on Vertex AI only.
       *
       * https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/add-labels-to-api-calls
       */
      labels: import_v46.z.record(import_v46.z.string(), import_v46.z.string()).optional(),
      /**
       * Optional. If specified, the media resolution specified will be used.
       *
       * https://ai.google.dev/api/generate-content#MediaResolution
       */
      mediaResolution: import_v46.z.enum([
       ...
       */
      imageConfig: import_v46.z.object({
        aspectRatio: import_v46.z.enum([
          "1:1",
          "2:3",
          "3:2",
          "3:4",
        ...
        imageSize: import_v46.z.enum(["1K", "2K", "4K", "512"]).optional(),
        /**
         * Optional. Controls the generation of people in images.
         * Vertex AI only.
         */
        personGeneration: import_v46.z.enum([
         ...
         */
        prominentPeople: import_v46.z.enum([
         ...
         * Vertex AI only.
         */
        imageOutputOptions: import_v46.z.object({
          mimeType: import_v46.z.enum(["image/jpeg", "image/png"]).optional(),
          compressionQuality: import_v46.z.number().optional()
        }).optional()
      }).optional(),
      /**
       ...
       */
      retrievalConfig: import_v46.z.object({
        latLng: import_v46.z.object({
          latitude: import_v46.z.number(),
          longitude: import_v46.z.number()
        }).optional()
      }).optional(),
      /**
       ...
       */
      streamFunctionCallArguments: import_v46.z.boolean().optional(),
      /**
       * Optional. The service tier to use for the request. Sent as the
       * `serviceTier` body field. Gemini API only.
       */
      serviceTier: import_v46.z.enum(["standard", "flex", "priority"]).optional(),
      /**
       ...
       */
      sharedRequestType: import_v46.z.enum(["priority", "flex", "standard"]).optional(),
      /**
       ...
       * https://docs.cloud.google.com/vertex-ai/generative-ai/docs/priority-paygo
       */
      requestType: import_v46.z.enum(["shared"]).optional()
    })
  )
);
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async getArgs({
    ...
    let googleOptions = await (0, import_provider_utils7.parseProviderOptions)({
      provider: providerOptionsName,
      providerOptions,
      schema: googleLanguageModelOptions
    });
    if (googleOptions == null && providerOptionsName !== "google") {
      googleOptions = await (0, import_provider_utils7.parseProviderOptions)({
        provider: "google",
        providerOptions,
        schema: googleLanguageModelOptions
      });
  ...
  async doGenerate(options) {
    ...
    const mergedHeaders = (0, import_provider_utils7.combineHeaders)(
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: (0, import_provider_utils7.createJsonResponseHandler)(responseSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    ...
    for (const part of parts) {
      if ("executableCode" in part && ((_g = part.executableCode) == null ? void 0 : _g.code)) {
        ...
        content.push({
          type: "tool-call",
          toolCallId: (_i = part.functionCall.id) != null ? _i : this.config.generateId(),
        ...
        const toolCallId = (_k = part.toolCall.id) != null ? _k : this.config.generateId();
        ...
        const responseToolCallId = (_m = lastServerToolCallId != null ? lastServerToolCallId : part.toolResponse.id) != null ? _m : this.config.generateId();
        content.push({
          type: "tool-result",
          toolCallId: responseToolCallId,
          toolName: `server:${part.toolResponse.toolType}`,
          result: (_n = part.toolResponse.response) != null ? _n : {},
          providerMetadata: part.thoughtSignature ? {
            [providerOptionsName]: {
              thoughtSignature: part.thoughtSignature,
    ...
    const sources = (_o = extractSources({
    ...
    return {
      content,
      finishReason: {
        unified: isPromptBlocked ? "content-filter" : mapGoogleGenerativeAIFinishReason({
      ...
      providerMetadata: {
        [providerOptionsName]: {
          promptFeedback: (_p = response.promptFeedback) != null ? _p : null,
          groundingMetadata: (_q = candidate == null ? void 0 : candidate.groundingMetadata) != null ? _q : null,
          urlContextMetadata: (_r = candidate == null ? void 0 : candidate.urlContextMetadata) != null ? _r : null,
          safetyRatings: (_s = candidate == null ? void 0 : candidate.safetyRatings) != null ? _s : null,
          usageMetadata: usageMetadata != null ? usageMetadata : null,
          finishMessage: (_t = candidate == null ? void 0 : candidate.finishMessage) != null ? _t : null,
          serviceTier: (_u = usageMetadata == null ? void 0 : usageMetadata.serviceTier) != null ? _u : null
        }
      },
      request: { body: args },
      response: {
        // TODO timestamp, model id
        id: (_v = response.responseId) != null ? _v : void 0,
        headers: responseHeaders,
        body: rawResponse
      }
    };
  ...
  async doStream(options) {
    ...
    const headers = (0, import_provider_utils7.combineHeaders)(
      await (0, import_provider_utils7.resolve)(this.config.headers),
      options.headers,
      extraHeaders
    );
    const { responseHeaders, value: response } = await (0, import_provider_utils7.postJsonToApi)({
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: (0, import_provider_utils7.createEventSourceResponseHandler)(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    let finishReason = {
      ...
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            ...
            if (content != null) {
              ...
              for (const part of parts) {
                if ("executableCode" in part && ((_f = part.executableCode) == null ? void 0 : _f.code)) {
                  ...
                  const toolCallId = (_h = part.toolCall.id) != null ? _h : generateId3();
                  lastServerToolCallId = toolCallId;
                  const serverMeta = {
                    [providerOptionsName]: {
                  ...
                  controller.enqueue({
                    ...
                    toolCallId,
                    toolName: `server:${part.toolCall.toolType}`,
                    input: JSON.stringify((_i = part.toolCall.args) != null ? _i : {}),
                    providerExecuted: true,
                    dynamic: true,
                    providerMetadata: serverMeta
                  });
                } else if ("toolResponse" in part && part.toolResponse) {
                  const responseToolCallId = (_j = lastServerToolCallId != null ? lastServerToolCallId : part.toolResponse.id) != null ? _j : generateId3();
                  const serverMeta = {
                    [providerOptionsName]: {
                      ...part.thoughtSignature ? { thoughtSignature: part.thoughtSignature } : {},
                      serverToolCallId: responseToolCallId,
              ...
              for (const part of parts) {
                ...
                if (isStreamingChunk) {
                  ...
                  const toolCallId = (_m = part.functionCall.id) != null ? _m : generateId3();
                  const toolName = part.functionCall.name;
                  const args2 = typeof part.functionCall.args === "string" ? part.functionCall.args : JSON.stringify((_n = part.functionCall.args) != null ? _n : {});
                  controller.enqueue({
                    type: "tool-input-start",
                    id: toolCallId,
                    toolName,
                  ...
                  const toolCallId = (_o = part.functionCall.id) != null ? _o : generateId3();
                  const toolName = part.functionCall.name;
                  controller.enqueue({
                    type: "tool-input-start",
                    id: toolCallId,
            ...
            const promptBlockReason = (_p = value.promptFeedback) == null ? void 0 : _p.blockReason;
            const isPromptBlocked = candidate.finishReason == null && promptBlockReason != null;
            const rawFinishReason = (_r = (_q = candidate.finishReason) != null ? _q : promptBlockReason) != null ? _r : void 0;
            if (rawFinishReason != null) {
              ...
              providerMetadata = {
                [providerOptionsName]: {
                  promptFeedback: (_s = value.promptFeedback) != null ? _s : null,
                  groundingMetadata: lastGroundingMetadata,
                  urlContextMetadata: lastUrlContextMetadata,
                  safetyRatings: (_t = candidate.safetyRatings) != null ? _t : null,
                  usageMetadata: usageMetadata != null ? usageMetadata : null,
                  finishMessage: (_u = candidate.finishMessage) != null ? _u : null,
                  serviceTier: (_v = usage == null ? void 0 : usage.serviceTier) != null ? _v : null
                }
              };
            }
          },
...
var getGroundingMetadataSchema = () => import_v47.z.object({
  webSearchQueries: import_v47.z.array(import_v47.z.string()).nullish(),
  imageSearchQueries: import_v47.z.array(import_v47.z.string()).nullish(),
  retrievalQueries: import_v47.z.array(import_v47.z.string()).nullish(),
  searchEntryPoint: import_v47.z.object({ renderedContent: import_v47.z.string() }).nullish(),
  groundingChunks: import_v47.z.array(
    import_v47.z.object({
      web: import_v47.z.object({ uri: import_v47.z.string(), title: import_v47.z.string().nullish() }).nullish(),
      image: import_v47.z.object({
        sourceUri: import_v47.z.string(),
        imageUri: import_v47.z.string(),
        title: import_v47.z.string().nullish(),
        domain: import_v47.z.string().nullish()
      }).nullish(),
      retrievedContext: import_v47.z.object({
        uri: import_v47.z.string().nullish(),
        title: import_v47.z.string().nullish(),
        text: import_v47.z.string().nullish(),
        fileSearchStore: import_v47.z.string().nullish()
      }).nullish(),
      maps: import_v47.z.object({
        uri: import_v47.z.string().nullish(),
        title: import_v47.z.string().nullish(),
        text: import_v47.z.string().nullish(),
        placeId: import_v47.z.string().nullish()
      }).nullish()
    })
  ).nullish(),
  groundingSupports: import_v47.z.array(
    import_v47.z.object({
      segment: import_v47.z.object({
        startIndex: import_v47.z.number().nullish(),
        endIndex: import_v47.z.number().nullish(),
        text: import_v47.z.string().nullish()
      }).nullish(),
      segment_text: import_v47.z.string().nullish(),
      groundingChunkIndices: import_v47.z.array(import_v47.z.number()).nullish(),
      supportChunkIndices: import_v47.z.array(import_v47.z.number()).nullish(),
      confidenceScores: import_v47.z.array(import_v47.z.number()).nullish(),
      confidenceScore: import_v47.z.array(import_v47.z.number()).nullish()
    })
  ).nullish(),
  retrievalMetadata: import_v47.z.union([
    import_v47.z.object({
      webDynamicRetrievalScore: import_v47.z.number()
    }),
    import_v47.z.object({})
  ]).nullish()
});
var partialArgSchema = import_v47.z.object({
  jsonPath: import_v47.z.string(),
  stringValue: import_v47.z.string().nullish(),
  numberValue: import_v47.z.number().nullish(),
  boolValue: import_v47.z.boolean().nullish(),
  nullValue: import_v47.z.unknown().nullish(),
  willContinue: import_v47.z.boolean().nullish()
});
var getContentSchema = () => import_v47.z.object({
    ...
    import_v47.z.union([
      ...
      import_v47.z.object({
        functionCall: import_v47.z.object({
          ...
          args: import_v47.z.unknown().nullish(),
          partialArgs: import_v47.z.array(partialArgSchema).nullish(),
          willContinue: import_v47.z.boolean().nullish()
        }),
      ...
      import_v47.z.object({
        toolCall: import_v47.z.object({
          toolType: import_v47.z.string(),
          args: import_v47.z.unknown().nullish(),
      ...
      import_v47.z.object({
        toolResponse: import_v47.z.object({
          toolType: import_v47.z.string(),
          response: import_v47.z.unknown().nullish(),
          id: import_v47.z.string()
        }),
        thoughtSignature: import_v47.z.string().nullish()
      }),
      import_v47.z.object({
        ...
        codeExecutionResult: import_v47.z.object({
          ...
          output: import_v47.z.string().nullish()
        }).nullish(),
        text: import_v47.z.string().nullish(),
        thought: import_v47.z.boolean().nullish(),
        thoughtSignature: import_v47.z.string().nullish()
...
var getSafetyRatingSchema = () => import_v47.z.object({
...
var tokenDetailsSchema = import_v47.z.array(
  import_v47.z.object({
    modality: import_v47.z.string(),
    tokenCount: import_v47.z.number()
...
var usageSchema = import_v47.z.object({
  ...
  toolUsePromptTokenCount: import_v47.z.number().nullish(),
  totalTokenCount: import_v47.z.number().nullish(),
  // https://cloud.google.com/vertex-ai/generative-ai/docs/reference/rest/v1/GenerateContentResponse#TrafficType
  trafficType: import_v47.z.string().nullish(),
  serviceTier: import_v47.z.string().nullish(),
...
var getUrlContextMetadataSchema = () => import_v47.z.object({
  urlMetadata: import_v47.z.array(
    import_v47.z.object({
      retrievedUrl: import_v47.z.string(),
      urlRetrievalStatus: import_v47.z.string()
    })
  ).nullish()
});
var responseSchema = (0, import_provider_utils7.lazySchema)(
  () => (0, import_provider_utils7.zodSchema)(
    import_v47.z.object({
      responseId: import_v47.z.string().nullish(),
      candidates: import_v47.z.array(
        import_v47.z.object({
          content: getContentSchema().nullish().or(import_v47.z.object({}).strict()),
          finishReason: import_v47.z.string().nullish(),
          finishMessage: import_v47.z.string().nullish(),
          safetyRatings: import_v47.z.array(getSafetyRatingSchema()).nullish(),
...
var chunkSchema = (0, import_provider_utils7.lazySchema)(
  () => (0, import_provider_utils7.zodSchema)(
    import_v47.z.object({
      responseId: import_v47.z.string().nullish(),
      candidates: import_v47.z.array(
...
var codeExecution = (0, import_provider_utils8.createProviderToolFactoryWithOutputSchema)({
...
var enterpriseWebSearch = (0, import_provider_utils9.createProviderToolFactory)({
  id: "google.enterprise_web_search",
  inputSchema: (0, import_provider_utils9.lazySchema)(() => (0, import_provider_utils9.zodSchema)(import_v49.z.object({})))
});

// src/tool/file-search.ts
var import_provider_utils10 = require("@ai-sdk/provider-utils");
var import_v410 = require("zod/v4");
var fileSearchArgsBaseSchema = import_v410.z.object({
  /** The names of the file_search_stores to retrieve from.
   *  Example: `fileSearchStores/my-file-search-store-123`
   */
  fileSearchStoreNames: import_v410.z.array(import_v410.z.string()).describe(
    "The names of the file_search_stores to retrieve from. Example: `fileSearchStores/my-file-search-store-123`"
  ),
  /** The number of file search retrieval chunks to retrieve. */
  topK: import_v410.z.number().int().positive().describe("The number of file search retrieval chunks to retrieve.").optional(),
  /** Metadata filter to apply to the file search retrieval documents.
   *  See https://google.aip.dev/160 for the syntax of the filter expression.
   */
  metadataFilter: import_v410.z.string().describe(
    "Metadata filter to apply to the file search retrieval documents. See https://google.aip.dev/160 for the syntax of the filter expression."
  ).optional()
}).passthrough();
var fileSearchArgsSchema = (0, import_provider_utils10.lazySchema)(
  () => (0, import_provider_utils10.zodSchema)(fileSearchArgsBaseSchema)
);
var fileSearch = (0, import_provider_utils10.createProviderToolFactory)({
...
var googleMaps = (0, import_provider_utils11.createProviderToolFactory)({
  id: "google.google_maps",
  inputSchema: (0, import_provider_utils11.lazySchema)(() => (0, import_provider_utils11.zodSchema)(import_v411.z.object({})))
});

// src/tool/google-search.ts
var import_provider_utils12 = require("@ai-sdk/provider-utils");
var import_v412 = require("zod/v4");
var googleSearchToolArgsBaseSchema = import_v412.z.object({
  searchTypes: import_v412.z.object({
    webSearch: import_v412.z.object({}).optional(),
    imageSearch: import_v412.z.object({}).optional()
  }).optional(),
  timeRangeFilter: import_v412.z.object({
    startTime: import_v412.z.string(),
    endTime: import_v412.z.string()
  }).optional()
}).passthrough();
var googleSearchToolArgsSchema = (0, import_provider_utils12.lazySchema)(
  () => (0, import_provider_utils12.zodSchema)(googleSearchToolArgsBaseSchema)
);
var googleSearch = (0, import_provider_utils12.createProviderToolFactory)(
  {
...
var urlContext = (0, import_provider_utils13.createProviderToolFactory)({
  id: "google.url_context",
  inputSchema: (0, import_provider_utils13.lazySchema)(() => (0, import_provider_utils13.zodSchema)(import_v413.z.object({})))
});

// src/tool/vertex-rag-store.ts
var import_provider_utils14 = require("@ai-sdk/provider-utils");
var import_v414 = require("zod/v4");
var vertexRagStore = (0, import_provider_utils14.createProviderToolFactory)({
  id: "google.vertex_rag_store",
  inputSchema: import_v414.z.object({
    ragCorpus: import_v414.z.string(),
    topK: import_v414.z.number().optional()
  })
});
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerateImagen(options) {
    ...
    const { responseHeaders, value: response } = await (0, import_provider_utils15.postJsonToApi)({
      ...
      headers: (0, import_provider_utils15.combineHeaders)(await (0, import_provider_utils15.resolve)(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
  ...
  async doGenerateGemini(options) {
    ...
    const googleImageOptions = await (0, import_provider_utils15.parseProviderOptions)({
      provider: "google",
      providerOptions,
      schema: googleImageModelOptionsSchema
    });
    ...
    const languageModel = new GoogleGenerativeAILanguageModel(this.modelId, {
      ...
      fetch: this.config.fetch,
      generateId: (_c = this.config.generateId) != null ? _c : import_provider_utils15.generateId
    });
    ...
    for (const part of result.content) {
      if (part.type === "file" && part.mediaType.startsWith("image/")) {
        images.push((0, import_provider_utils15.convertToBase64)(part.data));
      }
    }
...
var googleImageResponseSchema = (0, import_provider_utils15.lazySchema)(
  () => (0, import_provider_utils15.zodSchema)(
    import_v415.z.object({
      predictions: import_v415.z.array(import_v415.z.object({ bytesBase64Encoded: import_v415.z.string() })).default([])
    })
  )
);
var googleImageModelOptionsSchema = (0, import_provider_utils15.lazySchema)(
  () => (0, import_provider_utils15.zodSchema)(
    import_v415.z.object({
      personGeneration: import_v415.z.enum(["dont_allow", "allow_adult", "allow_all"]).nullish(),
      aspectRatio: import_v415.z.enum(["1:1", "3:4", "4:3", "9:16", "16:9"]).nullish(),
      /**
  ...
  async doGenerate(options) {
    ...
    for (const generatedSample of response.generateVideoResponse.generatedSamples) {
      if ((_h = generatedSample.video) == null ? void 0 : _h.uri) {
        const urlWithAuth = apiKey && (0, import_provider_utils16.isSameOrigin)(generatedSample.video.uri, this.config.baseURL) ? `${generatedSample.video.uri}${generatedSample.video.uri.includes("?") ? "&" : "?"}key=${apiKey}` : generatedSample.video.uri;
        videos.push({
          type: "url",
          url: urlWithAuth,
          mediaType: "video/mp4"
...
var googleOperationSchema = import_v416.z.object({
  name: import_v416.z.string().nullish(),
  done: import_v416.z.boolean().nullish(),
  error: import_v416.z.object({
    code: import_v416.z.number().nullish(),
    message: import_v416.z.string(),
    status: import_v416.z.string().nullish()
  }).nullish(),
  response: import_v416.z.object({
    generateVideoResponse: import_v416.z.object({
      generatedSamples: import_v416.z.array(
        import_v416.z.object({
          video: import_v416.z.object({
            uri: import_v416.z.string().nullish()
          }).nullish()
        })
      ).nullish()
    }).nullish()
...
var googleVideoModelOptionsSchema = (0, import_provider_utils16.lazySchema)(
  () => (0, import_provider_utils16.zodSchema)(
    import_v416.z.object({
      ...
      personGeneration: import_v416.z.enum(["dont_allow", "allow_adult", "allow_all"]).nullish(),
      negativePrompt: import_v416.z.string().nullish(),
      referenceImages: import_v416.z.array(
        import_v416.z.object({
          bytesBase64Encoded: import_v416.z.string().nullish(),
          gcsUri: import_v416.z.string().nullish()
        })
      ).nullish()
    }).passthrough()
  )
...
function convertFilePartToContent({
  ...
  return {
    type: kind,
    data: (0, import_provider_utils17.convertToBase64)(part.data),
...
function safeParseToolArgs(input) {
  try {
    const parsed = (0, import_provider_utils17.secureJsonParse)(input);
...
var tokenByModalitySchema = () => import_v417.z.object({
  modality: import_v417.z.string().nullish(),
  tokens: import_v417.z.number().nullish()
}).loose();
var usageSchema2 = () => import_v417.z.object({
  total_input_tokens: import_v417.z.number().nullish(),
  total_output_tokens: import_v417.z.number().nullish(),
  total_thought_tokens: import_v417.z.number().nullish(),
  total_cached_tokens: import_v417.z.number().nullish(),
  total_tool_use_tokens: import_v417.z.number().nullish(),
  total_tokens: import_v417.z.number().nullish(),
  input_tokens_by_modality: import_v417.z.array(tokenByModalitySchema()).nullish(),
  output_tokens_by_modality: import_v417.z.array(tokenByModalitySchema()).nullish(),
  cached_tokens_by_modality: import_v417.z.array(tokenByModalitySchema()).nullish(),
  tool_use_tokens_by_modality: import_v417.z.array(tokenByModalitySchema()).nullish(),
  grounding_tool_count: import_v417.z.array(
    import_v417.z.object({
      type: import_v417.z.string().nullish(),
      count: import_v417.z.number().nullish()
    }).loose()
  ).nullish()
}).loose();
var interactionStatusSchema = () => import_v417.z.enum([
  "in_progress",
  "requires_action",
  "completed",
  "failed",
...
var annotationSchema = () => {
  const urlCitation = import_v417.z.object({
    type: import_v417.z.literal("url_citation"),
    url: import_v417.z.string().nullish(),
    title: import_v417.z.string().nullish(),
    start_index: import_v417.z.number().nullish(),
    end_index: import_v417.z.number().nullish()
  }).loose();
  const fileCitation = import_v417.z.object({
    type: import_v417.z.literal("file_citation"),
    file_name: import_v417.z.string().nullish(),
    document_uri: import_v417.z.string().nullish(),
    url: import_v417.z.string().nullish(),
    page_number: import_v417.z.number().nullish(),
    media_id: import_v417.z.string().nullish(),
    start_index: import_v417.z.number().nullish(),
    end_index: import_v417.z.number().nullish(),
    custom_metadata: import_v417.z.record(import_v417.z.string(), import_v417.z.unknown()).nullish()
  }).loose();
  const placeCitation = import_v417.z.object({
    type: import_v417.z.literal("place_citation"),
    name: import_v417.z.string().nullish(),
    url: import_v417.z.string().nullish(),
    place_id: import_v417.z.string().nullish(),
    start_index: import_v417.z.number().nullish(),
    end_index: import_v417.z.number().nullish()
  }).loose();
  return import_v417.z.union([
    urlCitation,
    fileCitation,
    placeCitation,
...
var thoughtSummaryItemSchema = () => import_v417.z.object({
  type: import_v417.z.string(),
  text: import_v417.z.string().nullish(),
  data: import_v417.z.string().nullish(),
  mime_type: import_v417.z.string().nullish()
}).loose();
var contentBlockSchema = () => {
  const textContent = import_v417.z.object({
    type: import_v417.z.literal("text"),
    text: import_v417.z.string(),
    annotations: import_v417.z.array(annotationSchema()).nullish()
  }).loose();
  const imageContent = import_v417.z.object({
    type: import_v417.z.literal("image"),
    data: import_v417.z.string().nullish(),
    mime_type: import_v417.z.string().nullish(),
    resolution: import_v417.z.enum(["low", "medium", "high", "ultra_high"]).nullish(),
    uri: import_v417.z.string().nullish()
  }).loose();
  const videoContent = import_v417.z.object({
    type: import_v417.z.literal("video"),
    data: import_v417.z.string().nullish(),
    mime_type: import_v417.z.string().nullish(),
    uri: import_v417.z.string().nullish()
  }).loose();
...
var stepSchema = () => {
  const userInputStep = import_v417.z.object({
    type: import_v417.z.literal("user_input"),
    content: import_v417.z.array(contentBlockSchema()).nullish()
  }).loose();
  const modelOutputStep = import_v417.z.object({
    type: import_v417.z.literal("model_output"),
    content: import_v417.z.array(contentBlockSchema()).nullish()
  }).loose();
  const functionCallStep = import_v417.z.object({
    type: import_v417.z.literal("function_call"),
    id: import_v417.z.string(),
    name: import_v417.z.string(),
    arguments: import_v417.z.record(import_v417.z.string(), import_v417.z.unknown()).nullish(),
    signature: import_v417.z.string().nullish()
  }).loose();
  const thoughtStep = import_v417.z.object({
    type: import_v417.z.literal("thought"),
    signature: import_v417.z.string().nullish(),
    summary: import_v417.z.array(thoughtSummaryItemSchema()).nullish()
  }).loose();
  const builtinToolCallStep = import_v417.z.object({
    type: import_v417.z.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
    id: import_v417.z.string(),
    arguments: import_v417.z.record(import_v417.z.string(), import_v417.z.unknown()).nullish(),
    name: import_v417.z.string().nullish(),
    server_name: import_v417.z.string().nullish(),
    search_type: import_v417.z.string().nullish(),
    signature: import_v417.z.string().nullish()
  }).loose();
  const builtinToolResultStep = import_v417.z.object({
    type: import_v417.z.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
    call_id: import_v417.z.string(),
    result: import_v417.z.unknown().nullish(),
    is_error: import_v417.z.boolean().nullish(),
    name: import_v417.z.string().nullish(),
    server_name: import_v417.z.string().nullish(),
    signature: import_v417.z.string().nullish()
  }).loose();
...
var googleInteractionsResponseSchema = (0, import_provider_utils18.lazySchema)(
  () => (0, import_provider_utils18.zodSchema)(
    import_v417.z.object({
       ...
       */
      id: import_v417.z.string().nullish(),
      created: import_v417.z.string().nullish(),
      updated: import_v417.z.string().nullish(),
      status: interactionStatusSchema(),
      model: import_v417.z.string().nullish(),
      agent: import_v417.z.string().nullish(),
      steps: import_v417.z.array(stepSchema()).nullish(),
      usage: usageSchema2().nullish(),
      service_tier: import_v417.z.string().nullish(),
      previous_interaction_id: import_v417.z.string().nullish(),
      response_modalities: import_v417.z.array(import_v417.z.string()).nullish()
    }).loose()
  )
);
var googleInteractionsEventSchema = (0, import_provider_utils18.lazySchema)(
  () => (0, import_provider_utils18.zodSchema)(
    (() => {
      const status = interactionStatusSchema();
      const annotation = annotationSchema();
      const thoughtSummaryItem = thoughtSummaryItemSchema();
      const interactionCreatedEvent = import_v417.z.object({
        event_type: import_v417.z.literal("interaction.created"),
        event_id: import_v417.z.string().nullish(),
        interaction: import_v417.z.object({
          /*
      ...
      const stepStartEvent = import_v417.z.object({
        event_type: import_v417.z.literal("step.start"),
        event_id: import_v417.z.string().nullish(),
        index: import_v417.z.number(),
        step: stepSchema()
      }).loose();
      const stepDeltaText = import_v417.z.object({
        type: import_v417.z.literal("text"),
        text: import_v417.z.string()
      }).loose();
      const stepDeltaThoughtSummary = import_v417.z.object({
        type: import_v417.z.literal("thought_summary"),
        content: thoughtSummaryItem.nullish()
      }).loose();
      const stepDeltaThoughtSignature = import_v417.z.object({
        type: import_v417.z.literal("thought_signature"),
        signature: import_v417.z.string().nullish()
      }).loose();
      const stepDeltaArgumentsDelta = import_v417.z.object({
        type: import_v417.z.literal("arguments_delta"),
        arguments: import_v417.z.string().nullish(),
        id: import_v417.z.string().nullish(),
        signature: import_v417.z.string().nullish()
      }).loose();
      const stepDeltaTextAnnotation = import_v417.z.object({
        type: import_v417.z.enum(["text_annotation_delta", "text_annotation"]),
        annotations: import_v417.z.array(annotation).nullish()
      }).loose();
      const stepDeltaImage = import_v417.z.object({
        type: import_v417.z.literal("image"),
        data: import_v417.z.string().nullish(),
        mime_type: import_v417.z.string().nullish(),
        resolution: import_v417.z.enum(["low", "medium", "high", "ultra_high"]).nullish(),
      ...
      const stepDeltaVideo = import_v417.z.object({
        type: import_v417.z.literal("video"),
        data: import_v417.z.string().nullish(),
        mime_type: import_v417.z.string().nullish(),
        uri: import_v417.z.string().nullish()
      }).loose();
      const stepDeltaBuiltinToolCall = import_v417.z.object({
        type: import_v417.z.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
        id: import_v417.z.string().nullish(),
        arguments: import_v417.z.record(import_v417.z.string(), import_v417.z.unknown()).nullish(),
        name: import_v417.z.string().nullish(),
      ...
      const stepDeltaBuiltinToolResult = import_v417.z.object({
        type: import_v417.z.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
      ...
      const stepDeltaUnknown = import_v417.z.object({ type: import_v417.z.string() }).loose();
      const stepDeltaUnion = import_v417.z.union([
        stepDeltaText,
        stepDeltaImage,
        stepDeltaVideo,
      ...
      const stepDeltaEvent = import_v417.z.object({
        event_type: import_v417.z.literal("step.delta"),
        event_id: import_v417.z.string().nullish(),
        index: import_v417.z.number(),
        delta: stepDeltaUnion
      }).loose();
      const stepStopEvent = import_v417.z.object({
        event_type: import_v417.z.literal("step.stop"),
        event_id: import_v417.z.string().nullish(),
        index: import_v417.z.number()
      }).loose();
      const interactionStatusUpdateEvent = import_v417.z.object({
        event_type: import_v417.z.literal("interaction.status_update"),
        event_id: import_v417.z.string().nullish(),
        interaction_id: import_v417.z.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionInProgressEvent = import_v417.z.object({
        event_type: import_v417.z.literal("interaction.in_progress"),
        event_id: import_v417.z.string().nullish(),
        interaction_id: import_v417.z.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionRequiresActionEvent = import_v417.z.object({
        event_type: import_v417.z.literal("interaction.requires_action"),
        event_id: import_v417.z.string().nullish(),
        interaction_id: import_v417.z.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionCompletedEvent = import_v417.z.object({
        event_type: import_v417.z.literal("interaction.completed"),
        event_id: import_v417.z.string().nullish(),
        interaction: import_v417.z.object({
          id: import_v417.z.string().nullish(),
          status: status.nullish(),
      ...
      const errorEvent = import_v417.z.object({
        event_type: import_v417.z.literal("error"),
        event_id: import_v417.z.string().nullish(),
      ...
      const unknownEvent = import_v417.z.object({ event_type: import_v417.z.string() }).loose();
      return import_v417.z.union([
...
var googleInteractionsLanguageModelOptions = (0, import_provider_utils19.lazySchema)(
  () => (0, import_provider_utils19.zodSchema)(
    import_v418.z.object({
      previousInteractionId: import_v418.z.string().nullish(),
      store: import_v418.z.boolean().nullish(),
      agent: import_v418.z.string().nullish(),
      agentConfig: import_v418.z.union([
        import_v418.z.object({
          type: import_v418.z.literal("dynamic")
        }).loose(),
        import_v418.z.object({
          type: import_v418.z.literal("deep-research"),
          thinkingSummaries: import_v418.z.enum(["auto", "none"]).nullish(),
          visualization: import_v418.z.enum(["off", "auto"]).nullish(),
          collaborativePlanning: import_v418.z.boolean().nullish()
        })
      ]).nullish(),
      thinkingLevel: import_v418.z.enum(["minimal", "low", "medium", "high"]).nullish(),
      thinkingSummaries: import_v418.z.enum(["auto", "none"]).nullish(),
      /**
       ...
       */
      responseFormat: import_v418.z.array(
        import_v418.z.union([
          import_v418.z.object({
            type: import_v418.z.literal("text"),
            mimeType: import_v418.z.string().nullish(),
            schema: import_v418.z.unknown().nullish()
          }).loose(),
          import_v418.z.object({
            type: import_v418.z.literal("image"),
            mimeType: import_v418.z.string().nullish(),
            aspectRatio: import_v418.z.enum([
              "1:1",
              "2:3",
              "3:2",
              "3:4",
            ...
            imageSize: import_v418.z.enum(["1K", "2K", "4K", "512"]).nullish()
          }).loose(),
          import_v418.z.object({
            type: import_v418.z.literal("audio"),
            mimeType: import_v418.z.string().nullish()
          }).loose(),
          import_v418.z.object({
            type: import_v418.z.literal("video"),
            aspectRatio: import_v418.z.enum(["16:9", "9:16"]).nullish(),
            resolution: import_v418.z.enum(["360p", "720p", "1080p", "4k"]).nullish(),
            duration: import_v418.z.string().nullish(),
            delivery: import_v418.z.enum(["inline", "uri"]).nullish(),
            gcsUri: import_v418.z.string().nullish()
          }).loose()
        ])
      ).nullish(),
      /**
       ...
       */
      imageConfig: import_v418.z.object({
        aspectRatio: import_v418.z.enum([
          "1:1",
          "2:3",
          "3:2",
      ...
      mediaResolution: import_v418.z.enum(["low", "medium", "high", "ultra_high"]).nullish(),
      responseModalities: import_v418.z.array(import_v418.z.enum(["text", "image", "audio", "video", "document"])).nullish(),
      serviceTier: import_v418.z.enum(["flex", "standard", "priority"]).nullish(),
      /**
       * Alternative to AI SDK `system` message. If both are set, the AI SDK
       * `system` message wins and a warning is emitted.
       */
      systemInstruction: import_v418.z.string().nullish(),
      /**
       ...
       */
      pollingTimeoutMs: import_v418.z.number().int().positive().nullish(),
      /**
       ...
       * requires.
       */
      background: import_v418.z.boolean().nullish(),
      /**
       ...
       */
      environment: import_v418.z.union([
        import_v418.z.string(),
        import_v418.z.object({
          type: import_v418.z.literal("remote"),
          sources: import_v418.z.array(
            import_v418.z.union([
              import_v418.z.object({
                type: import_v418.z.literal("gcs"),
                source: import_v418.z.string(),
                target: import_v418.z.string().nullish()
              }),
              import_v418.z.object({
                type: import_v418.z.literal("repository"),
                source: import_v418.z.string(),
                target: import_v418.z.string().nullish()
              }),
              import_v418.z.object({
                type: import_v418.z.literal("inline"),
                content: import_v418.z.string(),
                target: import_v418.z.string()
              })
            ])
          ).nullish(),
          network: import_v418.z.union([
            import_v418.z.literal("disabled"),
            import_v418.z.object({
              allowlist: import_v418.z.array(
                import_v418.z.object({
                  domain: import_v418.z.string(),
                  transform: import_v418.z.array(import_v418.z.record(import_v418.z.string(), import_v418.z.string())).nullish()
                })
              )
            })
          ]).nullish()
...
async function cancelGoogleInteraction({
  ...
  try {
    const response = await fetch(url, {
      method: "POST",
      headers: (0, import_provider_utils20.withUserAgentSuffix)(
        (0, import_provider_utils20.combineHeaders)({ "Content-Type": "application/json" }, headers),
        (0, import_provider_utils20.getRuntimeEnvironmentUserAgent)()
      ),
      body: "{}"
    });
    try {
...
async function pollGoogleInteractionUntilTerminal({
  ...
  try {
    while (true) {
      ...
      await (0, import_provider_utils21.delay)(nextDelayMs, { abortSignal });
      const {
        value: response,
        rawValue: rawResponse,
        responseHeaders
      } = await (0, import_provider_utils21.getFromApi)({
        url,
        headers,
        failedResponseHandler: googleFailedResponseHandler,
        successfulResponseHandler: (0, import_provider_utils21.createJsonResponseHandler)(
    ...
    if ((0, import_provider_utils21.isAbortError)(error)) {
      await cancelOnServer();
    }
    throw error;
  }
...
function streamGoogleInteractionEvents({
  ...
  async function openReader() {
    const { value: stream } = await (0, import_provider_utils22.getFromApi)({
      url: buildUrl(),
        ...
        while (!complete && !effectiveSignal.aborted) {
          if (currentReader == null) {
            try {
              ...
              if ((0, import_provider_utils22.isAbortError)(error) || effectiveSignal.aborted) {
              ...
              await (0, import_provider_utils22.delay)(retryDelayMs * attempt, {
                abortSignal: effectiveSignal
              });
              continue;
            }
...
var GoogleInteractionsLanguageModel = class {
  ...
  async getArgs(options) {
    ...
    const warnings = [];
    const opts = await (0, import_provider_utils23.parseProviderOptions)({
      provider: "google",
      providerOptions: options.providerOptions,
    ...
    const {
      ...
      previousInteractionId: (_m = opts == null ? void 0 : opts.previousInteractionId) != null ? _m : void 0,
      store: (_n = opts == null ? void 0 : opts.store) != null ? _n : void 0,
      mediaResolution: (_o = opts == null ? void 0 : opts.mediaResolution) != null ? _o : void 0
    });
    warnings.push(...convWarnings);
    let systemInstruction = convertedSystemInstruction;
    const optionSystemInstruction = (_p = opts == null ? void 0 : opts.systemInstruction) != null ? _p : void 0;
    ...
    if (isAgent) {
      ...
      generationConfig = pruneUndefined({
        ...
        thinking_level: (_v = opts == null ? void 0 : opts.thinkingLevel) != null ? _v : void 0,
        thinking_summaries: (_w = opts == null ? void 0 : opts.thinkingSummaries) != null ? _w : void 0,
    ...
    if (isAgent && (opts == null ? void 0 : opts.agentConfig) != null) {
      ...
      if (ac.type === "deep-research") {
        agentConfig = pruneUndefined({
          type: "deep-research",
          thinking_summaries: (_x = ac.thinkingSummaries) != null ? _x : void 0,
          visualization: (_y = ac.visualization) != null ? _y : void 0,
          collaborative_planning: (_z = ac.collaborativePlanning) != null ? _z : void 0
        });
    ...
    if ((opts == null ? void 0 : opts.environment) != null) {
      if (!isAgent) {
        ...
        const sources = (_A = env.sources) == null ? void 0 : _A.map((s) => {
          var _a2;
          if (s.type === "inline") {
            return {
              type: "inline",
    ...
    const args = pruneUndefined({
      ...
      previous_interaction_id: (_B = opts == null ? void 0 : opts.previousInteractionId) != null ? _B : void 0,
      service_tier: (_C = opts == null ? void 0 : opts.serviceTier) != null ? _C : void 0,
      store: (_D = opts == null ? void 0 : opts.store) != null ? _D : void 0,
      generation_config: generationConfig != null && Object.keys(generationConfig).length > 0 ? generationConfig : void 0,
      agent_config: agentConfig,
      environment,
      background: (_E = opts == null ? void 0 : opts.background) != null ? _E : void 0
    });
    return {
      args,
      warnings,
      ...
      pollingTimeoutMs: (_F = opts == null ? void 0 : opts.pollingTimeoutMs) != null ? _F : void 0
    };
  }
  async doGenerate(options) {
    var _a, _b, _c, _d, _e, _f;
    ...
    const mergedHeaders = (0, import_provider_utils23.combineHeaders)(
      INTERACTIONS_API_REVISION_HEADER,
      this.config.headers ? await (0, import_provider_utils23.resolve)(this.config.headers) : void 0,
      options.headers
    );
    const postResult = await (0, import_provider_utils23.postJsonToApi)({
      url,
      headers: mergedHeaders,
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: (0, import_provider_utils23.createJsonResponseHandler)(
        googleInteractionsResponseSchema
      ),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    ...
    const { content, hasFunctionCall } = parseGoogleInteractionsOutputs({
      steps: (_b = response.steps) != null ? _b : null,
      generateId: (_c = this.config.generateId) != null ? _c : import_provider_utils23.generateId,
      interactionId
    });
    const finishReason = {
      unified: mapGoogleInteractionsFinishReason({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await (0, import_provider_utils23.postJsonToApi)({
      url,
      headers: mergedHeaders,
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: (0, import_provider_utils23.createEventSourceResponseHandler)(
        googleInteractionsEventSchema
      ),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    ...
    const transform = buildGoogleInteractionsStreamTransform({
      warnings,
      generateId: (_a = this.config.generateId) != null ? _a : import_provider_utils23.generateId,
  ...
  async doStreamBackground({
    ...
    const transform = buildGoogleInteractionsStreamTransform({
      warnings,
      generateId: (_b = this.config.generateId) != null ? _b : import_provider_utils23.generateId,
      includeRawChunks: options.includeRawChunks,
      serviceTier: headerServiceTier
    });
    return {
...
function createGoogleGenerativeAI(options = {}) {
  var _a, _b;
  const baseURL = (_a = (0, import_provider_utils24.withoutTrailingSlash)(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const providerName = (_b = options.name) != null ? _b : "google.generative-ai";
  const getHeaders = () => (0, import_provider_utils24.withUserAgentSuffix)(
    {
      "x-goog-api-key": (0, import_provider_utils24.loadApiKey)({
