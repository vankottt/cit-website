...
var googleTranscriptionModelOptions = z2.object({
  /**
   ...
   */
  languageCodes: z2.array(z2.string()).optional(),
  /**
   * Custom vocabulary phrases, which bias the speech recognition model
   * toward recognizing specific terms.
   */
  customVocabulary: z2.array(z2.string()).optional(),
  /**
   * Enables word-level timestamp generation.
   */
  wordTimestamp: z2.boolean().optional(),
  /**
   * Enables speaker diarization.
   */
  diarization: z2.boolean().optional(),
  /**
   ...
   */
  mode: z2.enum(["SMART", "VERBATIM"]).optional()
});
...
var googleInteractionsWordAnnotationSchema = z3.object({
  type: z3.string().nullish(),
  text: z3.string().nullish(),
  speaker: z3.string().nullish(),
  start_offset: z3.string().nullish(),
  end_offset: z3.string().nullish()
});
var googleInteractionsTranscriptionResponseSchema = z3.object({
    ...
    z3.object({
      ...
      content: z3.array(
        z3.object({
          type: z3.string().nullish(),
          text: z3.string().nullish(),
          annotations: z3.array(googleInteractionsWordAnnotationSchema).nullish()
        })
      ).nullish()
    })
  ).nullish(),
  usage: z3.record(z3.string(), z3.unknown()).nullish()
});
...
var googleEmbeddingContentPartSchema = z4.union([
...
var googleEmbeddingModelOptions = lazySchema2(
  () => zodSchema2(
    z4.object({
       ...
       */
      outputDimensionality: z4.number().optional(),
      /**
       ...
       */
      content: z4.array(z4.array(googleEmbeddingContentPartSchema).min(1).nullable()).optional()
    })
  )
);
...
var googleGenerativeAITextEmbeddingResponseSchema = lazySchema3(
  () => zodSchema3(
    z5.object({
      embeddings: z5.array(z5.object({ values: z5.array(z5.number()) }))
    })
  )
);
var googleGenerativeAISingleEmbeddingResponseSchema = lazySchema3(
  () => zodSchema3(
    z5.object({
      embedding: z5.object({ values: z5.array(z5.number()) })
    })
  )
);
...
import { convertToBase64 as convertToBase642, secureJsonParse } from "@ai-sdk/provider-utils";
...
var googleLanguageModelOptions = lazySchema4(
  () => zodSchema4(
    z6.object({
      responseModalities: z6.array(z6.enum(["TEXT", "IMAGE"])).optional(),
      thinkingConfig: z6.object({
        thinkingBudget: z6.number().optional(),
        includeThoughts: z6.boolean().optional(),
        // https://ai.google.dev/gemini-api/docs/gemini-3?thinking=high#thinking_level
        thinkingLevel: z6.enum(["minimal", "low", "medium", "high"]).optional()
      }).optional(),
      /**
       * Optional.
       ...
       */
      cachedContent: z6.string().optional(),
      /**
       ...
       */
      structuredOutputs: z6.boolean().optional(),
      /**
       * Optional. A list of unique safety settings for blocking unsafe content.
       */
      safetySettings: z6.array(
        z6.object({
          category: z6.enum([
       ...
       */
      audioTimestamp: z6.boolean().optional(),
      /**
       * Optional. Defines labels used in billing reports. Available on Vertex AI only.
       *
       * https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/add-labels-to-api-calls
       */
      labels: z6.record(z6.string(), z6.string()).optional(),
      /**
       * Optional. If specified, the media resolution specified will be used.
       *
       * https://ai.google.dev/api/generate-content#MediaResolution
       */
      mediaResolution: z6.enum([
      ...
      imageConfig: z6.object({
        ...
        imageSize: z6.enum(["1K", "2K", "4K", "512"]).optional(),
        /**
         * Optional. Controls the generation of people in images.
         * Vertex AI only.
         */
        personGeneration: z6.enum([
         ...
         * Vertex AI only.
         */
        imageOutputOptions: z6.object({
          mimeType: z6.enum(["image/jpeg", "image/png"]).optional(),
          compressionQuality: z6.number().optional()
        }).optional()
      }).optional(),
      /**
       ...
       */
      streamFunctionCallArguments: z6.boolean().optional(),
      /**
       * Optional. The service tier to use for the request. Sent as the
       * `serviceTier` body field. Gemini API only.
       */
      serviceTier: z6.enum(["standard", "flex", "priority"]).optional(),
      /**
       ...
       */
      sharedRequestType: z6.enum(["priority", "flex", "standard"]).optional(),
      /**
       ...
       * https://docs.cloud.google.com/vertex-ai/generative-ai/docs/priority-paygo
       */
      requestType: z6.enum(["shared"]).optional()
    })
  )
);
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async getArgs({
    ...
    let googleOptions = await parseProviderOptions3({
...
var getGroundingMetadataSchema = () => z7.object({
  webSearchQueries: z7.array(z7.string()).nullish(),
  imageSearchQueries: z7.array(z7.string()).nullish(),
  retrievalQueries: z7.array(z7.string()).nullish(),
  searchEntryPoint: z7.object({ renderedContent: z7.string() }).nullish(),
  groundingChunks: z7.array(
    z7.object({
      web: z7.object({ uri: z7.string(), title: z7.string().nullish() }).nullish(),
      image: z7.object({
        sourceUri: z7.string(),
        imageUri: z7.string(),
        title: z7.string().nullish(),
        domain: z7.string().nullish()
      }).nullish(),
      retrievedContext: z7.object({
        uri: z7.string().nullish(),
        title: z7.string().nullish(),
        text: z7.string().nullish(),
        fileSearchStore: z7.string().nullish()
      }).nullish(),
      maps: z7.object({
        uri: z7.string().nullish(),
        title: z7.string().nullish(),
        text: z7.string().nullish(),
        placeId: z7.string().nullish()
      }).nullish()
    })
  ).nullish(),
  groundingSupports: z7.array(
    z7.object({
      segment: z7.object({
        startIndex: z7.number().nullish(),
        endIndex: z7.number().nullish(),
        text: z7.string().nullish()
      }).nullish(),
      segment_text: z7.string().nullish(),
      groundingChunkIndices: z7.array(z7.number()).nullish(),
      supportChunkIndices: z7.array(z7.number()).nullish(),
      confidenceScores: z7.array(z7.number()).nullish(),
      confidenceScore: z7.array(z7.number()).nullish()
    })
  ).nullish(),
  retrievalMetadata: z7.union([
    z7.object({
      webDynamicRetrievalScore: z7.number()
    }),
    z7.object({})
  ]).nullish()
});
var partialArgSchema = z7.object({
  jsonPath: z7.string(),
  stringValue: z7.string().nullish(),
  numberValue: z7.number().nullish(),
  boolValue: z7.boolean().nullish(),
  nullValue: z7.unknown().nullish(),
  willContinue: z7.boolean().nullish()
});
var getContentSchema = () => z7.object({
  parts: z7.array(
    z7.union([
      ...
      z7.object({
        functionCall: z7.object({
          ...
          args: z7.unknown().nullish(),
          partialArgs: z7.array(partialArgSchema).nullish(),
          willContinue: z7.boolean().nullish()
        }),
      ...
      z7.object({
        toolResponse: z7.object({
          toolType: z7.string(),
          response: z7.unknown().nullish(),
          id: z7.string()
        }),
        thoughtSignature: z7.string().nullish()
      }),
...
var getSafetyRatingSchema = () => z7.object({
...
var tokenDetailsSchema = z7.array(
  z7.object({
    modality: z7.string(),
    tokenCount: z7.number()
  }).catchall(z7.json())
).nullish();
var usageSchema = z7.object({
  ...
  toolUsePromptTokenCount: z7.number().nullish(),
  totalTokenCount: z7.number().nullish(),
  // https://cloud.google.com/vertex-ai/generative-ai/docs/reference/rest/v1/GenerateContentResponse#TrafficType
  trafficType: z7.string().nullish(),
  serviceTier: z7.string().nullish(),
...
var getUrlContextMetadataSchema = () => z7.object({
  urlMetadata: z7.array(
    z7.object({
      retrievedUrl: z7.string(),
      urlRetrievalStatus: z7.string()
    })
  ).nullish()
});
var responseSchema = lazySchema5(
  () => zodSchema5(
    z7.object({
      responseId: z7.string().nullish(),
      candidates: z7.array(
        z7.object({
          content: getContentSchema().nullish().or(z7.object({}).strict()),
          finishReason: z7.string().nullish(),
          finishMessage: z7.string().nullish(),
          safetyRatings: z7.array(getSafetyRatingSchema()).nullish(),
...
var enterpriseWebSearch = createProviderToolFactory({
  ...
  inputSchema: lazySchema6(() => zodSchema6(z9.object({})))
});
...
var fileSearchArgsBaseSchema = z10.object({
  /** The names of the file_search_stores to retrieve from.
   *  Example: `fileSearchStores/my-file-search-store-123`
   */
  fileSearchStoreNames: z10.array(z10.string()).describe(
    "The names of the file_search_stores to retrieve from. Example: `fileSearchStores/my-file-search-store-123`"
  ),
  /** The number of file search retrieval chunks to retrieve. */
  topK: z10.number().int().positive().describe("The number of file search retrieval chunks to retrieve.").optional(),
  /** Metadata filter to apply to the file search retrieval documents.
   *  See https://google.aip.dev/160 for the syntax of the filter expression.
   */
  metadataFilter: z10.string().describe(
...
var googleMaps = createProviderToolFactory3({
  ...
  inputSchema: lazySchema8(() => zodSchema8(z11.object({})))
});
...
var googleSearchToolArgsBaseSchema = z12.object({
  searchTypes: z12.object({
    webSearch: z12.object({}).optional(),
    imageSearch: z12.object({}).optional()
  }).optional(),
  timeRangeFilter: z12.object({
...
var urlContext = createProviderToolFactory5({
  ...
  inputSchema: lazySchema10(() => zodSchema10(z13.object({})))
});
...
var vertexRagStore = createProviderToolFactory6({
  ...
  inputSchema: z14.object({
    ragCorpus: z14.string(),
    topK: z14.number().optional()
  })
});
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerateImagen(options) {
    ...
    const { responseHeaders, value: response } = await postJsonToApi4({
      ...
      headers: combineHeaders4(await resolve4(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
  ...
  async doGenerateGemini(options) {
    ...
    for (const part of result.content) {
      if (part.type === "file" && part.mediaType.startsWith("image/")) {
        images.push(convertToBase643(part.data));
      }
    }
...
var googleImageResponseSchema = lazySchema11(
  () => zodSchema11(
    z15.object({
      predictions: z15.array(z15.object({ bytesBase64Encoded: z15.string() })).default([])
    })
  )
);
var googleImageModelOptionsSchema = lazySchema11(
  () => zodSchema11(
    z15.object({
      ...
      aspectRatio: z15.enum(["1:1", "3:4", "4:3", "9:16", "16:9"]).nullish(),
      /**
...
import { convertToBase64 as convertToBase644, secureJsonParse as secureJsonParse2 } from "@ai-sdk/provider-utils";
...
function convertFilePartToContent({
  ...
  return {
    type: kind,
    data: convertToBase644(part.data),
...
var tokenByModalitySchema = () => z17.object({
  modality: z17.string().nullish(),
  tokens: z17.number().nullish()
}).loose();
var usageSchema2 = () => z17.object({
  total_input_tokens: z17.number().nullish(),
  total_output_tokens: z17.number().nullish(),
  total_thought_tokens: z17.number().nullish(),
  total_cached_tokens: z17.number().nullish(),
  total_tool_use_tokens: z17.number().nullish(),
  total_tokens: z17.number().nullish(),
  input_tokens_by_modality: z17.array(tokenByModalitySchema()).nullish(),
  output_tokens_by_modality: z17.array(tokenByModalitySchema()).nullish(),
  cached_tokens_by_modality: z17.array(tokenByModalitySchema()).nullish(),
  tool_use_tokens_by_modality: z17.array(tokenByModalitySchema()).nullish(),
  grounding_tool_count: z17.array(
    z17.object({
      type: z17.string().nullish(),
      count: z17.number().nullish()
    }).loose()
  ).nullish()
}).loose();
var interactionStatusSchema = () => z17.enum([
  "in_progress",
  "requires_action",
  "completed",
  "failed",
...
var annotationSchema = () => {
  ...
  const fileCitation = z17.object({
    type: z17.literal("file_citation"),
    file_name: z17.string().nullish(),
    document_uri: z17.string().nullish(),
    url: z17.string().nullish(),
    page_number: z17.number().nullish(),
    media_id: z17.string().nullish(),
    start_index: z17.number().nullish(),
    end_index: z17.number().nullish(),
    custom_metadata: z17.record(z17.string(), z17.unknown()).nullish()
  }).loose();
  const placeCitation = z17.object({
    type: z17.literal("place_citation"),
    name: z17.string().nullish(),
    url: z17.string().nullish(),
    place_id: z17.string().nullish(),
    start_index: z17.number().nullish(),
    end_index: z17.number().nullish()
  }).loose();
  return z17.union([
...
var thoughtSummaryItemSchema = () => z17.object({
  type: z17.string(),
  text: z17.string().nullish(),
  data: z17.string().nullish(),
  mime_type: z17.string().nullish()
}).loose();
var contentBlockSchema = () => {
  const textContent = z17.object({
    type: z17.literal("text"),
    text: z17.string(),
    annotations: z17.array(annotationSchema()).nullish()
  }).loose();
  const imageContent = z17.object({
    type: z17.literal("image"),
    data: z17.string().nullish(),
    mime_type: z17.string().nullish(),
    resolution: z17.enum(["low", "medium", "high", "ultra_high"]).nullish(),
    uri: z17.string().nullish()
  }).loose();
  const videoContent = z17.object({
    type: z17.literal("video"),
    data: z17.string().nullish(),
    mime_type: z17.string().nullish(),
    uri: z17.string().nullish()
  }).loose();
...
var stepSchema = () => {
  const userInputStep = z17.object({
    type: z17.literal("user_input"),
    content: z17.array(contentBlockSchema()).nullish()
  }).loose();
  const modelOutputStep = z17.object({
    type: z17.literal("model_output"),
    content: z17.array(contentBlockSchema()).nullish()
  }).loose();
  const functionCallStep = z17.object({
    type: z17.literal("function_call"),
    id: z17.string(),
    name: z17.string(),
    arguments: z17.record(z17.string(), z17.unknown()).nullish(),
    signature: z17.string().nullish()
  }).loose();
  const thoughtStep = z17.object({
    type: z17.literal("thought"),
    signature: z17.string().nullish(),
    summary: z17.array(thoughtSummaryItemSchema()).nullish()
  }).loose();
  const builtinToolCallStep = z17.object({
    type: z17.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
    id: z17.string(),
    arguments: z17.record(z17.string(), z17.unknown()).nullish(),
    name: z17.string().nullish(),
    server_name: z17.string().nullish(),
    search_type: z17.string().nullish(),
    signature: z17.string().nullish()
  }).loose();
  const builtinToolResultStep = z17.object({
    type: z17.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
    call_id: z17.string(),
    result: z17.unknown().nullish(),
    is_error: z17.boolean().nullish(),
    name: z17.string().nullish(),
    server_name: z17.string().nullish(),
    signature: z17.string().nullish()
  }).loose();
...
var googleInteractionsResponseSchema = lazySchema13(
  () => zodSchema13(
    z17.object({
      ...
      created: z17.string().nullish(),
      updated: z17.string().nullish(),
      status: interactionStatusSchema(),
      model: z17.string().nullish(),
      agent: z17.string().nullish(),
      steps: z17.array(stepSchema()).nullish(),
      usage: usageSchema2().nullish(),
      service_tier: z17.string().nullish(),
      previous_interaction_id: z17.string().nullish(),
      response_modalities: z17.array(z17.string()).nullish()
    }).loose()
  )
);
var googleInteractionsEventSchema = lazySchema13(
  () => zodSchema13(
    (() => {
      ...
      const interactionCreatedEvent = z17.object({
        event_type: z17.literal("interaction.created"),
        event_id: z17.string().nullish(),
        interaction: z17.object({
          /*
      ...
      const stepStartEvent = z17.object({
        event_type: z17.literal("step.start"),
        event_id: z17.string().nullish(),
        index: z17.number(),
        step: stepSchema()
      }).loose();
      const stepDeltaText = z17.object({
        type: z17.literal("text"),
        text: z17.string()
      }).loose();
      const stepDeltaThoughtSummary = z17.object({
        type: z17.literal("thought_summary"),
        content: thoughtSummaryItem.nullish()
      }).loose();
      const stepDeltaThoughtSignature = z17.object({
        type: z17.literal("thought_signature"),
        signature: z17.string().nullish()
      }).loose();
      const stepDeltaArgumentsDelta = z17.object({
        type: z17.literal("arguments_delta"),
        arguments: z17.string().nullish(),
        id: z17.string().nullish(),
        signature: z17.string().nullish()
      }).loose();
      const stepDeltaTextAnnotation = z17.object({
        type: z17.enum(["text_annotation_delta", "text_annotation"]),
        annotations: z17.array(annotation).nullish()
      }).loose();
      const stepDeltaImage = z17.object({
        type: z17.literal("image"),
        data: z17.string().nullish(),
        mime_type: z17.string().nullish(),
        resolution: z17.enum(["low", "medium", "high", "ultra_high"]).nullish(),
      ...
      const stepDeltaVideo = z17.object({
        type: z17.literal("video"),
        data: z17.string().nullish(),
        mime_type: z17.string().nullish(),
        uri: z17.string().nullish()
      }).loose();
      const stepDeltaBuiltinToolCall = z17.object({
        type: z17.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
        id: z17.string().nullish(),
        arguments: z17.record(z17.string(), z17.unknown()).nullish(),
        name: z17.string().nullish(),
      ...
      const stepDeltaBuiltinToolResult = z17.object({
        type: z17.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
      ...
      const stepDeltaUnknown = z17.object({ type: z17.string() }).loose();
      const stepDeltaUnion = z17.union([
        stepDeltaText,
        stepDeltaImage,
        stepDeltaVideo,
      ...
      const stepDeltaEvent = z17.object({
        event_type: z17.literal("step.delta"),
        event_id: z17.string().nullish(),
        index: z17.number(),
        delta: stepDeltaUnion
      }).loose();
      const stepStopEvent = z17.object({
        event_type: z17.literal("step.stop"),
        event_id: z17.string().nullish(),
        index: z17.number()
      }).loose();
      const interactionStatusUpdateEvent = z17.object({
        event_type: z17.literal("interaction.status_update"),
        event_id: z17.string().nullish(),
        interaction_id: z17.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionInProgressEvent = z17.object({
        event_type: z17.literal("interaction.in_progress"),
        event_id: z17.string().nullish(),
        interaction_id: z17.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionRequiresActionEvent = z17.object({
        event_type: z17.literal("interaction.requires_action"),
        event_id: z17.string().nullish(),
        interaction_id: z17.string().nullish(),
        status: status.nullish()
      }).loose();
      const interactionCompletedEvent = z17.object({
        event_type: z17.literal("interaction.completed"),
        event_id: z17.string().nullish(),
        interaction: z17.object({
          id: z17.string().nullish(),
          status: status.nullish(),
      ...
      const errorEvent = z17.object({
        event_type: z17.literal("error"),
        event_id: z17.string().nullish(),
        error: z17.object({
      ...
      const unknownEvent = z17.object({ event_type: z17.string() }).loose();
      return z17.union([
...
var googleInteractionsLanguageModelOptions = lazySchema14(
  () => zodSchema14(
    z18.object({
      previousInteractionId: z18.string().nullish(),
      store: z18.boolean().nullish(),
      agent: z18.string().nullish(),
      agentConfig: z18.union([
        z18.object({
          type: z18.literal("dynamic")
        }).loose(),
        z18.object({
          type: z18.literal("deep-research"),
          thinkingSummaries: z18.enum(["auto", "none"]).nullish(),
          visualization: z18.enum(["off", "auto"]).nullish(),
          collaborativePlanning: z18.boolean().nullish()
        })
      ]).nullish(),
      thinkingLevel: z18.enum(["minimal", "low", "medium", "high"]).nullish(),
      thinkingSummaries: z18.enum(["auto", "none"]).nullish(),
      /**
       ...
       */
      responseFormat: z18.array(
        z18.union([
          z18.object({
            type: z18.literal("text"),
            mimeType: z18.string().nullish(),
            schema: z18.unknown().nullish()
          }).loose(),
          z18.object({
            type: z18.literal("image"),
            mimeType: z18.string().nullish(),
            aspectRatio: z18.enum([
              "1:1",
              "2:3",
              "3:2",
              "3:4",
            ...
            imageSize: z18.enum(["1K", "2K", "4K", "512"]).nullish()
          }).loose(),
          z18.object({
          ...
          z18.object({
            type: z18.literal("video"),
            aspectRatio: z18.enum(["16:9", "9:16"]).nullish(),
            resolution: z18.enum(["360p", "720p", "1080p", "4k"]).nullish(),
            duration: z18.string().nullish(),
            delivery: z18.enum(["inline", "uri"]).nullish(),
            gcsUri: z18.string().nullish()
          }).loose()
        ])
      ).nullish(),
      /**
      ...
      mediaResolution: z18.enum(["low", "medium", "high", "ultra_high"]).nullish(),
      responseModalities: z18.array(z18.enum(["text", "image", "audio", "video", "document"])).nullish(),
      serviceTier: z18.enum(["flex", "standard", "priority"]).nullish(),
      /**
       * Alternative to AI SDK `system` message. If both are set, the AI SDK
       * `system` message wins and a warning is emitted.
       */
      systemInstruction: z18.string().nullish(),
      /**
       ...
       * `previousInteractionId`.
       */
      interactionId: z18.string().nullish(),
      /**
       ...
       */
      pollingTimeoutMs: z18.number().int().positive().nullish(),
      /**
       ...
       * requires.
       */
      background: z18.boolean().nullish(),
      /**
      ...
      environment: z18.union([
        ...
        z18.object({
          ...
          sources: z18.array(
            z18.union([
              z18.object({
                type: z18.literal("gcs"),
                source: z18.string(),
                target: z18.string().nullish()
              }),
              z18.object({
                type: z18.literal("repository"),
                source: z18.string(),
                target: z18.string().nullish()
              }),
              z18.object({
          ...
          network: z18.union([
            z18.literal("disabled"),
            z18.object({
              allowlist: z18.array(
                z18.object({
                  domain: z18.string(),
                  transform: z18.array(z18.record(z18.string(), z18.string())).nullish()
                })
              )
            })
          ]).nullish()
