    ...
    z12.object({
      ...
      responseFormat: z12.array(
        z12.union([
          ...
          z12.object({
            type: z12.literal("video"),
            aspectRatio: z12.enum(["16:9", "9:16"]).nullish(),
            resolution: z12.enum(["360p", "720p", "1080p", "4k"]).nullish(),
            duration: z12.string().nullish(),
            delivery: z12.enum(["inline", "uri"]).nullish(),
            gcsUri: z12.string().nullish()
          }).loose()
        ])
      ).nullish(),
      /**
