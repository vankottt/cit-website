...
function isRecursiveJSONSchemaReferenceError(error) {
  return import_provider.UnsupportedFunctionalityError.isInstance(error) && error.functionality.startsWith(recursiveReferenceFunctionalityPrefix);
}
            ...
            if (content != null) {
              ...
              for (const part of parts) {
                if ("executableCode" in part && ((_f = part.executableCode) == null ? void 0 : _f.code)) {
                  ...
                  const toolCallId = (_h = part.toolCall.id) != null ? _h : generateId2();
                  lastServerToolCallId = toolCallId;
                  const serverMeta = {
                    [providerOptionsName]: {
                  ...
                  const responseToolCallId = (_j = lastServerToolCallId != null ? lastServerToolCallId : part.toolResponse.id) != null ? _j : generateId2();
                  const serverMeta = {
                    [providerOptionsName]: {
                      ...part.thoughtSignature ? { thoughtSignature: part.thoughtSignature } : {},
                      serverToolCallId: responseToolCallId,
              ...
              for (const part of parts) {
                ...
                if (isStreamingChunk) {
                  ...
                  const toolCallId = (_m = part.functionCall.id) != null ? _m : generateId2();
                  ...
                  const toolCallId = (_o = part.functionCall.id) != null ? _o : generateId2();
                  const toolName = part.functionCall.name;
                  controller.enqueue({
                    type: "tool-input-start",
                    id: toolCallId,
...
var usageSchema = import_v43.z.object({
  ...
  toolUsePromptTokenCount: import_v43.z.number().nullish(),
    ...
    import_v412.z.object({
      ...
      responseFormat: import_v412.z.array(
        import_v412.z.union([
          ...
          import_v412.z.object({
            type: import_v412.z.literal("video"),
            aspectRatio: import_v412.z.enum(["16:9", "9:16"]).nullish(),
            resolution: import_v412.z.enum(["360p", "720p", "1080p", "4k"]).nullish(),
            duration: import_v412.z.string().nullish(),
            delivery: import_v412.z.enum(["inline", "uri"]).nullish(),
            gcsUri: import_v412.z.string().nullish()
          }).loose()
        ])
      ).nullish(),
      /**
