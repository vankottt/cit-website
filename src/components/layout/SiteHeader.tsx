...
export function SiteHeader({ locale }: { locale: Locale }) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-paper [--header-h:5.5rem]">
      <Container className="flex h-[var(--header-h)] items-center justify-between gap-6">
        <Logo locale={locale} layout="lockup" markSize={56} className="min-w-0 shrink xl:flex-none" />
