...
const base =
  "inline-flex h-12 items-center gap-2.5 rounded-ctrl px-5 font-sans text-small font-medium transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber";
