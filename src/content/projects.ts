...
export const projects: Project[] = [
  {
    ...
    outputs: {
      ...
      items: [
        { title: { bg: "System Map", en: "System Map" }, body: { bg: "Карта на действителната институционална, регулаторна и пазарна архитектура.", en: "A map of the actual institutional, regulatory and market architecture." } },
        { title: { bg: "Algorithm & Process Map", en: "Algorithm & Process Map" }, body: { bg: "Описание на ключовите процеси и алгоритми, чрез които се вземат решения и се формира пазарният резултат.", en: "A description of the key processes and algorithms through which decisions are made and the market result is formed." } },
        { title: { bg: "Failure Map", en: "Failure Map" }, body: { bg: "Идентифициране на системните, институционалните, административните, икономическите и поведенческите дефекти.", en: "Identification of systemic, institutional, administrative, economic and behavioural defects." } },
        { title: { bg: "Target Architecture", en: "Target Architecture" }, body: { bg: "Проект на подобрена институционална и функционална архитектура.", en: "A design for an improved institutional and functional architecture." } },
        { title: { bg: "Policy & Intervention Package", en: "Policy & Intervention Package" }, body: { bg: "Пакет от възможни законодателни, регулаторни, институционални, административни, икономически, маркетингови, образователни и поведенчески мерки.", en: "A package of possible legislative, regulatory, institutional, administrative, economic, marketing, educational and behavioural measures." } },
        { title: { bg: "Implementation Roadmap", en: "Implementation Roadmap" }, body: { bg: "Кой следва да направи какво, в каква последователност, с какъв ресурс и в какъв срок.", en: "Who should do what, in what sequence, with what resources and by when." } },
        { title: { bg: "KPI Framework", en: "KPI Framework" }, body: { bg: "Измерими показатели за оценка на реалния резултат.", en: "Measurable indicators for assessing the real result." } },
        { title: { bg: "Pilot Test Design", en: "Pilot Test Design" }, body: { bg: "Проект за пилотно внедряване на избрани решения в реална туристическа среда.", en: "A design for piloting selected solutions in a real tourism setting." } },
      ],
    },
    validation: {
      intro: {
